...
public class LeaveRequestRepositoryImpl implements LeaveRequestRepository {
    ...
    private static final String APPLY_LEAVE_QUERY = "INSERT INTO LEAVES (EMPLOYEE_ID, LEAVE_FROM, LEAVE_TO," + " LEAVE_TYPE, " + "LEAVE_REASON, LEAVE_STATUS, DAYS_TAKEN) " + "VALUES (?,?,?,?,?,?,?)";
    ...
    public void applyLeave(LeaveRequest leaveRequest) throws SQLException, ClassNotFoundException {
        ...
        LocalDate toDate = LocalDate.parse(leaveRequest.getFromDate(), dateFormatter);
...
//        status = pending
    ...
    public List<LeaveRequest> getMyLeaveRequests(String employeeMailId) throws SQLException, ClassNotFoundException {
        ...
        while (resultSet.next()) {
            ...
            LeaveRequest leaveRequest = new LeaveRequest(leaveId, employeeId, fromDate, toDate, leaveType, leaveReason, leaveStatus, daysCount);
    ...
    @Override
    public List<LeaveRequest> getMyLeavesRequestsByStatus(String employeeMailId, String leaveStatus) throws SQLException, ClassNotFoundException {
        ...
        LOGGER.info("Fetched {} leave requests for employee email: {} with status: {}", myLeaveRequests.size(), employeeMailId, leaveStatus);
        return myLeaveRequests;
    }
}
