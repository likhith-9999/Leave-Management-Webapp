...
public class HolidayServiceImpl implements HolidayService {
    public final HolidayRepository holidayRepository = new HolidayRepositoryImpl();

    @Override
    public Set<LocalDate[]> getOverlappingHolidaysService(LocalDate startDate, LocalDate endDate) throws SQLException, ClassNotFoundException {
