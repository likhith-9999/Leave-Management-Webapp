...
public class LeaveRequestServiceImpl implements LeaveRequestService {
    private static final LeaveRequestRepository leaveRequestRepository = LeaveRequestRepositoryImpl.getInstance();
    ...
    @Override
    public List<LeaveRequest> getMyLeaveRequestService(String employeeMailId) throws SQLException,
            ClassNotFoundException {
        return leaveRequestRepository.getMyLeaveRequests(employeeMailId);
    }

    public List<LeaveRequest> getMyLeaveRequestByStatusService(String employeeMailId, String leaveStatus) throws
