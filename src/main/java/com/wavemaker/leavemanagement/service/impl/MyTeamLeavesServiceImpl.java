...
public class MyTeamLeavesServiceImpl implements MyTeamLeavesService {
    MyTeamLeavesRepository myTeamLeavesRepository = MyTeamLeavesRepositoryImpl.getInstance();
    ...
    @Override
    public List<LeaveDTO> getMyTeamLeaveRequestsByStatusService(String managerMailId, String leaveStatus) throws
    ...
    @Override
    public List<Employee> getTeamDetails(String managerMailId) throws SQLException, ClassNotFoundException {
        return myTeamLeavesRepository.getMyTeamDetails(managerMailId);
    }
}
