    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            if (login) {
                ...
                cookieMap.put(unqId, Arrays.asList(emailID, manager));
                ...
                resp.getWriter().write(String.format("{\"status\": \"ok\", \"message\": \"Logged in\", \"isManager\":" +
                        " %b}", Boolean.parseBoolean(manager)));
            } else {
