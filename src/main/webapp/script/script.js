...
//    alert("leave applied");
   document.getElementById('leaveAppliedDialog-msg').textContent = `${leaveType} Applied for ${daysCount}`;
...
async function teamDetailsDashboard() {
    ...
    result.forEach(employee => {
        ...
        //const newBtn = `<button id=${employee.emailId} class="btn btn-outline-primary btn-inactive mb-2" onclick="getEmployeeDashBoard(${employee.emailId})">${employee.employeeName}</button>`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // const holidays = [
    //     { start: '2024-09-15', end: '2024-09-20' },
    //     { start: '2024-12-25', end: '2024-12-25' },
    ...
    fromDateInput.addEventListener('change', validateAndClearDateInput);
    toDateInput.addEventListener('change', validateAndClearDateInput);
});
